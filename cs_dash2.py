...
income_bands_inputs = dbc.Col(
      children=[        
          html.Div(
              children=[
                html.Div(children="Bands of the cost of children taper", className="menu-title"),
...
def update_liability_statement(kid_1_age_i,kid_2_age_i,kid_3_age_i,kid_4_age_i,kid_5_age_i,numkids
    ...
    # Set y-axes titles
    fig.update_yaxes(title_text="How much you give your partner", secondary_y=False)
